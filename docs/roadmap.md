...
- Qur'an, Sunnah, ijmaʿ, qiyas, istihsan, and recognized legal principles
...
A carefully sourced expansion covering the prophets named in the Qur'an, with attention to:
...
- lessons
- relevant locations
- chronology where evidence supports it
- clear distinction between Qur'anic material, sound hadith, and later historical reports

## Planned expansion: The Life of Prophet Muhammad ﷺ

A detailed chronological sīrah expansion from birth to death. Important events should receive their own cards when the sources support doing so rather than compressing the life of the Prophet ﷺ into a tiny summary set.

Planned coverage includes childhood, Khadijah رضي الله عنها, the first revelation, early Muslims, persecution, Abyssinia, the boycott, Taʾif, Israʾ and Miʿraj, ʿAqabah, Hijrah, Madinah, Badr, Uhud, the Trench, Hudaybiyyah, Khaybar, Muʾtah, the Conquest of Makkah, Hunayn, Tabuk, the Farewell Hajj, final illness, death, burial, and other well-attested events.
